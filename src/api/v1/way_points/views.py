...
from usecase.wapoint.delete_waypoint.abstract import \
    AbstractDeleteWaypointUseCase
...
from .dependencies import (create_waypoint_use_case, delete_waypoint_use_case,
                           get_waypoint_use_case, update_waypoint_use_case,)
...
@router.put("/{id}", response_model=WaypointUpdate, status_code=status.HTTP_200_OK)
...
@router.get("/{id}", response_model=WaypointSchema, status_code=status.HTTP_200_OK)
