...
from .dependencies import (create_user_use_case, delete_user_use_case,
                           get_user_use_case, update_user_use_case,)
from .models import CreateUserSchema, UserSchema, UpdateUserSchema
...
async def get_user_by_id(
    id: int, usecase: AbstractGetUserUseCase = Depends(get_user_use_case)
) -> JSONResponse:
    try:
